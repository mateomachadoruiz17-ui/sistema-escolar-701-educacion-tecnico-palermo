let users = {
  ...
  // 👨‍🏫 ADMIN PRINCIPAL
  representante:{pass:"7741",role:"admin"},

  // 👩 ADMIN
  natalia:{pass:"5592",role:"admin"},

  // 👀 SOLO VISUALIZACIÓN
  napoleon:{pass:"6638",role:"viewer"}
